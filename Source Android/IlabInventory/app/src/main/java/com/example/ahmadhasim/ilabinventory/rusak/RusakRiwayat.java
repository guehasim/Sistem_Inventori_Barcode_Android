 ...
 */
public class RusakRiwayat extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private static String url_select            = Server.URL + "rusak_select_riwayat.php";
    private static String url_delete            = Server.URL + "rusak_riwayat_delete.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rusak_riwayat);

        swipe   = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_layout_riwayat_rusak);

        adapter = new RusakRiwayatAdapter(RusakRiwayat.this, itemList);
    ...
    private void tahan(){
        list.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                dialog = new AlertDialog.Builder(RusakRiwayat.this);
            ...
            public void onClick(DialogInterface dialog, int which) {
                StringRequest strReq = new StringRequest(Request.Method.POST, url_delete, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(RusakRiwayat.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_SHORT).show();
                                adapter.notifyDataSetChanged();
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RusakRiwayat.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case android.R.id.home:
                ...
                return true;
            case R.id.search:
                Intent pl = new Intent(RusakRiwayat.this, RusakRiwayatCari.class);
                startActivity(pl);
                return true;
            default:
