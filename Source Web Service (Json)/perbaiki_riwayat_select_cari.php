<?php
	...
	$query = mysql_query("SELECT i.repair_id, i.repair_start_date, i.repair_done_date, i.broken_id, i.repair_condition_result, i.repair_repairer, i.repair_note,
							...
							iii.stuff_id, iiii.stuff_name 
								...
								WHERE i.repair_condition_result != '0' AND iiii.stuff_name='".$name."' ");
